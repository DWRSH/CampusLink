...
function SenderMessage({ message }) {
    ...
    return (
        <div 
            ref={scrollRef} 
            className='w-fit max-w-[60%] bg-gradient-to-br from-purple-600 to-pink-500 rounded-t-2xl rounded-bl-2xl rounded-br-none px-4 py-2 relative ml-auto flex flex-col gap-2 shadow-lg'
        >
            {/* Image */}
            {message.image && (
                <img 
